...
const cards: Cards = {
  ...
  _10_of_clubs: require("./10_of_clubs.png"),
  _10_of_diamonds: require("./10_of_diamonds.png"),
  _10_of_hearts: require("./10_of_hearts.png"),
  _10_of_spades: require("./10_of_spades.png"),
